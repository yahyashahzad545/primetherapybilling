      ...
      <div className="max-w-[1600px] mx-auto flex flex-col lg:flex-row lg:items-center lg:justify-center">
        ...
        <div className="w-full bg-white rounded-3xl p-7 sm:p-10 lg:p-14 shadow-[0_10px_40px_rgba(33,81,75,0.15)] border-2 border-[#57BA91] relative z-10 lg:w-[58%] lg:pr-24 lg:-mr-[4%]">
          ...
          <p className="text-[#21514B]/90 text-base leading-[1.8] mb-5">
            Provider enrollment and credentialing slow down far too many
            practices. One small mismatch, one outdated form, and payers stop
            the process cold. We step in early, fix the details, update CAQH,
            and manage insurance credentialing so approvals move smoothly and
            you stay on schedule without surprises.
          </p>
          <p className="text-[#21514B]/90 text-base leading-[1.8] mb-5">
            You&apos;re paired with a provider enrollment specialist who manages
            everything end-to-end. They prepare each application, follow payer
            guidelines, and keep the file moving with steady follow-ups. From
            insurance paneling to day-to-day credentialing and enrollment
            services, we remove delays before they turn into real problems.
          </p>
          <p className="text-[#21514B]/90 text-base leading-[1.8] mb-5">
            Our approach focuses on accuracy and momentum. We verify documents,
            track every payer request, and prevent credentialing gaps that
            interrupt billing. Whether you outsource provider enrollment or
            simply need help with a few plans, we keep your approvals moving
            until each payer signs off.
          </p>
          <p className="text-[#21514B]/90 text-base leading-[1.8] mb-8">
            Start your enrollment today or consult with a credentialing
            specialist who can guide you through the entire process, from
            initial setup to final payer approval.
          </p>
        ...
        <div className="w-full rounded-2xl p-7 sm:p-10 lg:p-12 bg-gradient-to-b from-[#21514B] to-[#57BA91] shadow-[0_20px_50px_rgba(33,81,75,0.3)] relative z-20 mt-8 lg:mt-0 lg:w-[46%]">
          ...
          {submitted ? (
            ...
            >
              ...
              Your credentialing request has been received. A specialist will
          ...
          <div className="flex flex-wrap justify-center gap-2.5 mt-5">
            <div className="flex items-center gap-1.5 bg-white px-3.5 py-2 rounded-full shadow-[0_2px_8px_rgba(0,0,0,0.1)]">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-wrap lg:flex-nowrap justify-center gap-5 lg:gap-4 xl:gap-6">
            ...
            {[
              ...
              <div key={i} className="w-full sm:w-[48%] lg:w-[calc(20%-12px)] xl:w-[220px] flex-shrink-0 flex flex-col items-center">
                <div className="relative w-full bg-[#57BA91] border-2 border-white/40 rounded-t-lg h-14 flex items-center justify-center px-3">
                  <span className="text-white font-bold text-sm text-center leading-tight">{card.title}</span>
                ...
                <div className="relative w-full bg-white border-2 border-[#21514B] rounded-b-lg mt-[10px] pt-[90px] pb-6 px-5 min-h-[270px] flex flex-col justify-end hover:-translate-y-1.5 hover:shadow-2xl hover:border-[#1C443E] transition-all duration-300">
                  <div className="absolute top-4 left-1/2 -translate-x-1/2 w-[70px] h-[70px] rounded-full bg-white border-4 border-[#21514B] flex items-center justify-center shadow-md">
                    <svg className="w-9 h-9 text-[#21514B]" fill="none" stroke="currentColor" viewBox="0 0 24 24">{card.icon}</svg>
                  </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div>
              ...
              <p className="text-gray-600 text-lg mb-6 leading-relaxed">
                ...
                certifications, and work history — and enrolling them with insurance
                companies to receive reimbursement for services rendered.
              </p>
              <p className="text-gray-600 text-lg mb-8 leading-relaxed">
                Without proper credentialing, healthcare providers{" "}
                <strong className="text-gray-900">cannot bill insurance companies</strong>{" "}
                and must collect directly from patients, significantly limiting their patient
                base and revenue potential.
              </p>
