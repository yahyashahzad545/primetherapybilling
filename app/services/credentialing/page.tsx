  ...
  const timeline = [
    {
      ...
      description:
        "We gather and verify all provider credentials, licenses, and supporting documents.",
    },
    {
      week: "Week 2-3",
      title: "CAQH & NPI Setup",
      description:
        "CAQH profile creation or update, NPI verification, and application preparation.",
    },
    {
      week: "Week 3-4",
      title: "Application Submission",
      description:
        "All insurance applications are submitted electronically and via mail where required.",
    },
    {
      week: "Week 4-8",
      title: "Active Follow-Up",
      description:
        "We contact payers every 7-10 days to track progress and resolve any issues.",
    },
    {
      week: "Week 8-12",
      title: "Approval & Go-Live",
      description:
        "Effective dates confirmed, fee schedules verified, and billing can begin.",
    },
  ];
      ...
      <section className="relative bg-gradient-to-br from-emerald-600 via-teal-700 to-cyan-800 text-white py-20 sm:py-28 lg:py-36 px-4 sm:px-6 text-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          ...
          <p className="text-lg sm:text-xl mb-10 max-w-2xl mx-auto text-teal-100 leading-relaxed">
            Get enrolled with insurance payers faster and start receiving
            payments without delays. We handle the complete credentialing and
            provider enrollment process from start to finish.
          </p>

          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <button className="bg-white text-emerald-700 px-8 py-4 rounded-xl font-bold shadow-xl hover:shadow-2xl hover:shadow-white/20 hover:-translate-y-1 transition-all duration-300 text-lg group">
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div>
              ...
              <p className="text-gray-600 text-lg mb-6 leading-relaxed">
                Medical credentialing is the essential process of verifying a
                healthcare provider&apos;s qualifications — including education,
                training, licenses, certifications, and work history — and
                enrolling them with insurance companies to receive reimbursement
                for services rendered.
              </p>
              <p className="text-gray-600 text-lg mb-8 leading-relaxed">
                Without proper credentialing, healthcare providers{" "}
                <strong className="text-gray-900">
                  cannot bill insurance companies
                </strong>{" "}
                and must collect directly from patients, significantly limiting
                their patient base and revenue potential.
              </p>
                ...
                <div className="space-y-5">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <div className="text-gray-600 text-sm">
                          Cannot bill insurance, limited patients, cash-only
                          payments, revenue loss
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-white rounded-2xl p-6 shadow-sm border border-green-200 hover:shadow-md transition-shadow duration-300">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <div className="text-gray-600 text-sm">
                          Bill all payers, accept all patients, timely payments,
                          maximum revenue
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 hover:shadow-md transition-shadow duration-300">
                    ...
                    <div className="mt-2 text-xs text-gray-500">
                      After proper insurance enrollment
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-14">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto text-lg">
              From individual provider enrollment to group practice
              credentialing, we handle every aspect of the process so you can
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
            {services.map((service, index) => (
              <div
                key={index}
                className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 hover:shadow-xl hover:shadow-emerald-500/10 hover:-translate-y-2 transition-all duration-500 group"
              >
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-14">
            ...
            <p className="text-emerald-200 max-w-2xl mx-auto text-lg">
              Our proven systematic approach ensures thorough, accurate, and
              timely credentialing with the highest approval rates in the
              industry.
            </p>
          </div>
      ...
      <section className="py-16 sm:py-20 lg:py-24 px-4 sm:px-6 bg-white">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-14">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto text-lg">
              Here&apos;s what to expect when you partner with us for your
              credentialing needs.
            </p>
          </div>
      ...
      <section className="py-16 sm:py-20 lg:py-24 px-4 sm:px-6 bg-slate-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-14">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto text-lg">
              Our experienced team handles credentialing for every type of
              healthcare provider across all specialties and practice settings.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
            {insurancePayers.map((payer, index) => (
              <div
                key={index}
                className="bg-slate-50 rounded-xl p-5 text-center border border-gray-100 hover:shadow-lg hover:shadow-emerald-500/10 hover:-translate-y-1 hover:border-emerald-200 transition-all duration-300 cursor-pointer group"
              >
                <div className="w-10 h-10 mx-auto mb-3 rounded-full bg-emerald-100 group-hover:bg-gradient-to-br group-hover:from-emerald-500 group-hover:to-teal-600 flex items-center justify-center transition-all duration-300">
                  <svg
                    className="w-5 h-5 text-emerald-600 group-hover:text-white transition-colors duration-300"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div>
              ...
              <p className="text-gray-600 text-lg mb-8 leading-relaxed">
                We make the document collection process simple and
                straightforward. Here&apos;s what you&apos;ll need to get
                started. Don&apos;t worry — our team will guide you through
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {documents.map((doc, index) => (
                <div
                  key={index}
                  className="flex items-center gap-3 bg-white rounded-xl p-4 border border-gray-100 hover:shadow-md hover:border-emerald-200 hover:-translate-y-0.5 transition-all duration-300 group cursor-pointer"
                >
                  <div className="w-8 h-8 bg-gradient-to-br from-emerald-500 to-teal-600 rounded-lg flex items-center justify-center text-white flex-shrink-0 group-hover:scale-110 transition-transform duration-300">
                    <svg
                      className="w-4 h-4"
      ...
      <section className="py-16 sm:py-20 lg:py-24 px-4 sm:px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-14">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto text-lg">
              We combine industry expertise, proven processes, and cutting-edge
              technology to deliver the fastest and most reliable credentialing
              services.
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
            {whyChooseUs.map((item, index) => (
              <div
                key={index}
                className="bg-slate-50 rounded-2xl p-8 border border-gray-100 hover:bg-white hover:shadow-xl hover:shadow-emerald-500/10 hover:-translate-y-2 transition-all duration-500 group"
              >
      ...
      <section className="py-16 sm:py-20 lg:py-24 px-4 sm:px-6 bg-gradient-to-br from-slate-900 via-emerald-950 to-teal-900 text-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-14">
            ...
            <p className="text-emerald-200 max-w-2xl mx-auto text-lg">
              Many practices struggle with credentialing. Here&apos;s how we
              turn common pain points into smooth processes.
            </p>
          </div>
            ...
            {[
              {
                ...
                solution:
                  "Our proactive follow-up and payer relationships cut enrollment time by 40-60% compared to industry averages.",
              },
              {
                challenge: "Application Rejections",
                solution:
                  "Our 98% first-pass approval rate means almost all applications are accepted on the first try without costly resubmissions.",
              },
              {
                challenge: "Missing or Expired Documents",
                solution:
                  "We track every document expiration date and proactively alert you well before renewal deadlines to prevent enrollment gaps.",
              },
              {
                challenge: "Complex Payer Requirements",
                solution:
                  "We maintain a database of requirements for 200+ payers, ensuring every application meets specific payer criteria and regulations.",
              },
              {
                challenge: "CAQH Profile Issues",
                solution:
                  "We manage your CAQH profile end-to-end including quarterly re-attestations, so your profile never falls out of compliance.",
              },
              {
                challenge: "Multi-State Credentialing",
                solution:
                  "Our team understands each state's unique requirements and manages multi-state enrollment seamlessly for growing practices.",
              },
            ].map((item, index) => (
              <div
                key={index}
              ...
              >
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-10 h-10 bg-red-500/20 rounded-lg flex items-center justify-center flex-shrink-0 group-hover:bg-green-500/20 transition-colors duration-500">
                    ...
                    <svg
                      className="w-5 h-5 text-green-400 hidden group-hover:block"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
      ...
      <section className="py-16 sm:py-20 lg:py-24 px-4 sm:px-6 bg-gradient-to-br from-emerald-600 via-teal-700 to-cyan-800 text-white relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          <p className="text-teal-100 text-lg sm:text-xl mb-10 max-w-2xl mx-auto leading-relaxed">
            Don&apos;t let credentialing delays hold back your practice. Start
            the enrollment process today and begin receiving insurance
            reimbursements in as little as 60 days.
          </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16">
            <div>
              ...
              <p className="text-gray-600 text-lg mb-10 leading-relaxed">
                Fill out the form and our credentialing specialists will contact
                you within 24 hours with a customized enrollment plan for your
                practice.
              </p>
                ...
                <div className="grid sm:grid-cols-2 gap-5">
                  <div>
                    ...
                    <input
                      type="text"
                      placeholder="John"
                      className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20 outline-none transition-all duration-300"
                    />
                  </div>
                  <div>
                    <label className="block text-sm font-semibold text-gray-700 mb-2">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
            <div>
              ...
              <p className="text-gray-400 leading-relaxed mb-6">
                Leading medical credentialing and provider enrollment company
                serving healthcare providers across all 50 US states.
              </p>
                ...
                {["facebook", "twitter", "linkedin", "instagram"].map(
                  (social) => (
                    <a
                      key={social}
                      href="#"
                      className="w-10 h-10 bg-white/10 rounded-lg flex items-center justify-center hover:bg-gradient-to-br hover:from-emerald-500 hover:to-teal-600 transition-all duration-300 hover:-translate-y-1"
                    >
                      <svg
                        className="w-5 h-5"
                        fill="currentColor"
            ...
            <div>
              ...
              <p className="text-gray-400 mb-4">
                Stay updated with credentialing tips, payer updates, and
                industry news.
              </p>
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 px-4 py-3 rounded-xl bg-white/10 border border-white/10 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20 outline-none transition-all duration-300 text-sm"
                />
                <button className="bg-gradient-to-r from-emerald-500 to-teal-600 px-5 py-3 rounded-xl font-semibold hover:shadow-lg hover:shadow-emerald-500/30 transition-all duration-300 text-sm whitespace-nowrap">
                  Subscribe
                </button>
              </div>
            </div>
