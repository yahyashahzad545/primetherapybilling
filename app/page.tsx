...
function StyledInput({ type = "text", placeholder, value, onChange }: any) {
  return (
    <input
      ...
      value={value}
      onChange={onChange}
      className="w-full px-4 py-3 rounded-xl border border-gray-200 outline-none text-sm text-gray-700 bg-white placeholder-gray-400"
    />
  );
}
  // ── Styled select ──────────────────────────────────────────────────────────
function StyledSelect({ options, value, onChange }: any) {
  return (
    <select
      value={value}
      onChange={onChange}
      className="w-full px-4 py-3 rounded-xl border border-gray-200 text-sm text-gray-700 bg-white"
    >
      <option value="">Select Your Specialty</option>
...
function StyledTextarea({ placeholder, value, onChange }: any) {
  return (
    <textarea
      ...
      value={value}
      onChange={onChange}
      className="w-full px-4 py-3 rounded-xl border border-gray-200 text-sm text-gray-700 bg-white placeholder-gray-400"
    />
  );
}
  // ══════════════════════════════════════════════════════════════════════════
...
>
  ...
  <StyledSelect
    ...
    onChange={(e: any) =>
      setHeroForm({ ...heroForm, practice: e.target.value })
    }
  />
  ...
  <StyledTextarea
    ...
    onChange={(e: any) =>
      setHeroForm({ ...heroForm, message: e.target.value })
    }
  />
